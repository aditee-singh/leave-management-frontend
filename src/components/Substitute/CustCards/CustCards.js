                    ...
                    {requestCards.map((rc, i) => (
                        ...
                        <CardContent>
                            ...
                            <Box sx={{ display: 'flex', p: 1, bgcolor: 'background.paper' }}>
                                <Box sx={{ p: 1, flexGrow: 1 }}><b>Date</b></Box>          
                                <Box sx={{ p: 1}}><b>Time</b></Box>
                            </Box>
                            <Box sx={{ display: 'flex', p: 1, bgcolor: 'background.paper' }}>
                            ...
                            <Box sx={{ display: 'flex', p: 1, bgcolor: 'background.paper' }}>
                                <Box sx={{ p: 1, flexGrow: 1 }}><b>Subject</b></Box>
                            </Box>
                            <Box sx={{ display: 'flex', p: 1, bgcolor: 'background.paper' }}>
                            ...
                            <Button variant="contained" size="small" sx={{margin:"20px"}} onClick={() => { subsStatus('accepted', i); }}>Accept</Button>
                            <Button variant="contained" size="small" onClick={() => { subsStatus('rejected', i) }}>Reject</Button>
                            </CardActions>
                      </Card>
                    ))}
...
{/* <Card sx={{ maxWidth: 345 }}>
                ...
                <Button variant="contained" size="small" >Reject</Button>
                </CardActions>
            </Card> */}
