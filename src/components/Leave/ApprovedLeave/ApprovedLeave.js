            ...
            <div style={{ marginRight: "20px", marginTop: "40px" }}>
                ...
                <TableContainer component={Paper}>
                  <Table  aria-label="simple table">
                      ...
                      <TableBody>
                        ...
                        <ApprovedLeavePartial approvedLeavePartial = {approvedLeavePartial} status="approved" />
                        }
                      </TableBody>        
                    </Table>
                </TableContainer>
                ...
                <TableContainer component={Paper}>
                  <Table  aria-label="simple table">
                      ...
                      <TableBody>
                        {approvedLeavePartial &&
                        <ApprovedLeavePartial approvedLeavePartial = {approvedLeavePartial} status="rejected" />
                        }
                      </TableBody>        
                    </Table>
                </TableContainer>
